...
4. `apps/server/src/games/` — `*-engine.ts` 파일 존재 여부 확인 (`{gameType}-engine.ts`)
...
| 체크포인트 | typing | gomoku | minesweeper | tetris | liar-drawing | catch-mind |
|---|---|---|---|---|---|---|
| GameType 유니온 | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| GAME_CONFIGS | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| game-manager 등록 | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
...
|---|---|---|---|---|
| typing | TypingPublicState | ✅ | TypingMove | ✅ |
...
|---|---|---|---|---|
| lobby | 11 | 11 | lobby-handler.ts | ✅ |
| game | 4 | 15 | game-handler.ts | ✅ |
| player | 2 | 1 | nickname-handler.ts | ✅ |
| chat | 5 | 4 | chat-handler.ts | ✅ |
| request | 6 | 5 | request-handler.ts | ✅ |
