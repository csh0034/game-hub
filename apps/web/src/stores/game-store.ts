...
import type { GameState, GameResult, LiarDrawingPrivateState, CatchMindPrivateState } from "@game-hub/shared-types";
...
interface GameStore {
  ...
  privateState: LiarDrawingPrivateState | CatchMindPrivateState | null;
  playerLeftInfo: PlayerLeftInfo | null;
  setGameState: (state: GameState) => void;
  setGameResult: (result: GameResult | null) => void;
  setPrivateState: (state: LiarDrawingPrivateState | CatchMindPrivateState) => void;
